...
function createStringSequence(a) {
    return {
        ...
        getElementAtIndex(pos) { return a.charCodeAt(pos); }
    };
}
...
class LcsDiff {
     ...
     */
    constructor(originalSequence, newSequence, continueProcessingPredicate = null) {
    ...
    WALKTRACE(diagonalForwardBase, diagonalForwardStart, diagonalForwardEnd, diagonalForwardOffset, diagonalReverseBase, diagonalReverseStart, diagonalReverseEnd, diagonalReverseOffset, forwardPoints, reversePoints, originalIndex, originalEnd, midOriginalArr, modifiedIndex, modifiedEnd, midModifiedArr, deltaIsEven, quitEarlyArr) {
        let forwardChanges = null, reverseChanges = null;
    ...
    ConcatenateChanges(left, right) {
        ...
        if (left.length === 0 || right.length === 0) {
            ...
            let result = new Array(left.length + right.length - 1);
