...
class PomodoroManager {
    constructor(workTime = 25, pauseTime = 5) {
        ...
        if (!this._statusBarStartButton) {
            this._statusBarStartButton = vscode_1.window.createStatusBarItem(vscode_1.StatusBarAlignment.Left);
        ...
        if (!this._statusBarPauseButton) {
            this._statusBarPauseButton = vscode_1.window.createStatusBarItem(vscode_1.StatusBarAlignment.Left);
    ...
    get currentState() {
        switch (this.currentPomodoro.status) {
            case pomodoroStatus_1.default.Work:
                return " - work";
            case pomodoroStatus_1.default.Rest:
                return " - rest";
            case pomodoroStatus_1.default.Paused:
                return " - paused";
            case pomodoroStatus_1.default.Break:
                return " - break";
            default:
                return "";
        }
    ...
    update() {
        ...
        if (this.currentPomodoro.status === pomodoroStatus_1.default.Done) {
            this._pomodoroIndex++;
    ...
    draw() {
        ...
        if (this.currentPomodoro.status === pomodoroStatus_1.default.None ||
            this.currentPomodoro.status === pomodoroStatus_1.default.Paused) {
            this._statusBarStartButton.show();
            this._statusBarPauseButton.hide();
        }
        else {
    ...
    reset() {
        this._pomodoroIndex = 0;
        this.pomodori = [];
        this.pomodori.push(new pomodoro_1.default(this.workTime * 60, this.pauseTime * 60));
    }
    dispose() {
...
exports.default = PomodoroManager;
//# sourceMappingURL=pomodoroManager.js.map